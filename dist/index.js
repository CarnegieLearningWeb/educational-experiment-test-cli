...
var port = '3030';
var baseUrl = "https://ees-backend.herokuapp.com/api/";
...
extendedGlobal.defineExperiment = function (segmentDefinition, group, unitOfAssignment, consistencyRule, postExperimentRule, conditions) { return __awaiter(void 0, void 0, void 0, function () {
    var url, postData, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                postData = JSON.stringify({
                    ...
                    segments: segmentDefinition.map(function (segmentInd) { return ({
